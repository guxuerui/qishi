...
function useTranslate() {
  if (props.percentValue.length >= 4)
    return 'translate(45 84)'
  else if (props.percentValue.length === 3)
  ...
  <svg width="195" height="195" class="scale-75" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="grident" x1="0%" y1="0%" x2="102%" y2="101%">
        <stop stop-color="#25AABE" offset="0%" />
        <stop stop-color="#C2FE89" offset="100%" />
      </linearGradient>
    </defs>
    <g fill="none" fill-rule="evenodd">
      ...
      <text font-size="40" font-weight="300" fill="#80BD68" :transform="useTranslate()">
        <tspan x="0" y="20">{{ percentValue }}</tspan>
      </text>
      <text font-size="20" font-weight="300" fill="#eee" transform="translate(68 104)">
